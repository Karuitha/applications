...
I have submitted my PhD thesis in Finance and will graduate in December 2022 from Wits. I am a research fellow at the African Centre for the Study of the United States of America where I research Africa-US economics and trade relations. Related articles are in my linkedin site. 
...
As a research assistant at the `Wits Business School` in South Africa, I have worked with the World Bank, IMF, MIX, and FRED data for five years. As a macroeconomic statistician specialising in sovereign debt with `Trounceflow` (UK, Remote), I collected and analysed global data on sovereign debt, debt deficits, and surpluses. I have also participated in field data collection and analysis with the `Kenya Institute of Public Policy Research and Analysis (KIPPRA)`. 

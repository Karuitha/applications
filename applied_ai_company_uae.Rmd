...
place <- "The Applied AI Company, UAE"
...
As a research assistant at the `Wits Business School` in South Africa, I have worked with the World Bank, IMF, MIX, and FRED data for five years. As a macroeconomic statistician specialising in sovereign debt with `Trounceflow` (UK, Remote), I collected and analysed global data on sovereign debt, debt deficits, and surpluses. I have also participated in field data collection and analysis with the `Kenya Institute of Public Policy Research and Analysis (KIPPRA)`. My post-graduate education also grounded me in research methodology, including data collection and management.
...
Given my background, I believe I can handle the tasks of `r jobtitle`. 

Please feel free to contact me for further information or clarification. Please see the next page for answers to the pertinent questions that you raised in the advertisement.
